...
Из графика видно характерное поведение логарифмической сложности O(log n). При росте n в 20 раз время выросло лишь в 1,53 раза (а log₂(20000)/log₂(1000) ≈ 1,43).
...
Из графика отчетливо видна линейная зависимость времени выполнения от количества элементов. График представляет собой прямую линию. При удвоении n время растёт в ≈ 2 раза.
...
При удвоении n время растёт ≈ 2,2–2,4, что соответствует формуле.
...
При удвоении n время растёт в ≈ 4 раза.
...
Из графика отчетливо видна линейная зависимость времени делённого на размер от количества элементов, соответственно сложность равна O(n²).
...
При удвоении n время растёт в ≈ 4,5–4,9 раз.
